...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'attributeId', array('class'=>'title')); ?>
		<?php echo $form->dropDownList($model,'attributeId',CHtml::listData($attributes, 'id', 'name'),array('prompt'=>'')); ?>
