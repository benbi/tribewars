...
class RaceController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Race']))
		{
			$model->attributes=$_POST['Race'];
      $image = new Image();
      $image->upload($model, 'Race');
      $model->imageId = $image->id;

      $bigImage = new Image();
      $bigImage->upload($model, 'Race', 'bigImageId');
  ...
  public function actionLoadImage ($id) {
	...
	{
		$dataProvider=new CActiveDataProvider('Race');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='race-form')
		{
